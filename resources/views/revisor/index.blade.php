    ...
    <div class="row justify-content-center mt-4">
        <div class="col-12 col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                {{-- Bottone rimuovi ruolo revisore --}}
                <form method="POST" action="{{ route('revisor.remove', auth()->user()) }}"
                    onsubmit="return confirm('{{ __('messages.revisor_remove_confirm') }}')">
                    @csrf
                    <button type="submit" class="btn-danger-presto btn-sm">
                        {{ __('messages.revisor_remove') }}
                    </button>
                </form>
            </div>
        </div>
                    ...
                    <div class="mt-3">
                        @foreach ($article->images as $image)
                            <div class="vision-card mb-3">
                                ...
                                <img src="{{ asset('storage/' . $image->path) }}" alt="Immagine" class="vision-img">
